...
docker restart --name  docker_21 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_22 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_23 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_24 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_25 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_26 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_27 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_28 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_29 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2a -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2b -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2c -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2d -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2e -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_2f -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6

docker restart --name  docker_30 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_31 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_32 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_33 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_34 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_35 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_36 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_37 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_38 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_39 -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_3a -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_3b -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_3c -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
docker restart --name  docker_3d -v /root/3proxyvol/cfg:/etc/3proxy/cfg --restart=always --env PROXY_LOGIN=9hits --env PROXY_PASSWORD=Buy9hitsDOTcom 9hits/3proxy4to6
