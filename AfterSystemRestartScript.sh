...
wget --inet4-only https://raw.githubusercontent.com/MoneyMakers777/DataMining/main/createdockers.sh
fi
...
wget --inet4-only https://raw.githubusercontent.com/MoneyMakers777/DataMining/main/restartdockers.sh
